    ...
    <main className="min-h-screen bg-zt-bg">
      ...
      <section className="pt-40 pb-32 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-playfair text-4xl md:text-5xl font-bold text-zt-text mb-4">Cookie Policy</h1>
          ...
          <div className="space-y-10 text-zt-text/60 text-base leading-relaxed">
            ...
            <div>
              <h2 className="font-playfair text-zt-text text-xl font-semibold mb-3">1. What Are Cookies</h2>
            ...
            <div>
              <h2 className="font-playfair text-zt-text text-xl font-semibold mb-3">2. Cookies We Use</h2>
              ...
              <ul className="list-disc list-inside mt-3 space-y-2 text-zt-text/50">
                <li><span className="text-zt-text/70">cookie_consent</span> — remembers your cookie preference (Accept or Decline)</li>
              </ul>
            ...
            <div>
              <h2 className="font-playfair text-zt-text text-xl font-semibold mb-3">3. What We Do Not Use</h2>
            ...
            <div>
              <h2 className="font-playfair text-zt-text text-xl font-semibold mb-3">4. Your Choices</h2>
              <p>When you first visit ZoraTech, you will be presented with a cookie banner. You may:</p>
              <ul className="list-disc list-inside mt-3 space-y-2 text-zt-text/50">
                <li><span className="text-zt-text/70">Accept</span> — allows the preference cookie to be stored</li>
                <li><span className="text-zt-text/70">Decline</span> — no cookies will be stored beyond this session</li>
              </ul>
              <p className="mt-3">You can also clear cookies at any time through your browser settings.</p>
            </div>

            <div>
              <h2 className="font-playfair text-zt-text text-xl font-semibold mb-3">5. Contact</h2>
