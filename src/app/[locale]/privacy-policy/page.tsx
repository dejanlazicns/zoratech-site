    ...
    <main className="min-h-screen bg-zt-bg">
      ...
      <section className="pt-40 pb-32 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-playfair text-4xl md:text-5xl font-bold text-zt-text mb-4">Privacy Policy</h1>
          ...
          <div className="space-y-10 text-zt-text/60 text-base leading-relaxed">
            ...
            <div>
              <h2 className="font-playfair text-zt-text text-xl font-semibold mb-3">1. What We Collect</h2>
            ...
            <div>
              <h2 className="font-playfair text-zt-text text-xl font-semibold mb-3">2. How We Use Your Data</h2>
            ...
            <div>
              <h2 className="font-playfair text-zt-text text-xl font-semibold mb-3">3. Data Sharing</h2>
            ...
            <div>
              <h2 className="font-playfair text-zt-text text-xl font-semibold mb-3">4. GDPR Compliance</h2>
              ...
              <ul className="list-disc list-inside mt-3 space-y-2 text-zt-text/50">
                <li><span className="text-zt-text/70">Right of access</span> — request a copy of the data we hold about you</li>
                <li><span className="text-zt-text/70">Right to rectification</span> — request correction of inaccurate data</li>
                <li><span className="text-zt-text/70">Right to erasure</span> — request complete deletion of your data</li>
                <li><span className="text-zt-text/70">Right to object</span> — object to the processing of your data</li>
              </ul>
            </div>

            <div>
              <h2 className="font-playfair text-zt-text text-xl font-semibold mb-3">5. Data Deletion Requests</h2>
            ...
            <div>
              <h2 className="font-playfair text-zt-text text-xl font-semibold mb-3">6. Data Retention</h2>
            ...
            <div>
              <h2 className="font-playfair text-zt-text text-xl font-semibold mb-3">7. Contact</h2>
